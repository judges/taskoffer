...
-(void)layoutSubviews
{
    ...
    [enterpriseContentLabel setFrame:CGRectMake(10, enterpriseCategoryLabel.frame.size.height + enterpriseCategoryLabel.frame.origin.y, self.frame.size.width - 90, 40)];
    ...
    [iconV setFrame:CGRectMake(self.frame.size.width-enterpriseNameLabel.frame.size.width-enterpriseNameLabel.frame.origin.x*2-20, enterpriseNameLabel.frame.origin.y+6, 12, 12)];
