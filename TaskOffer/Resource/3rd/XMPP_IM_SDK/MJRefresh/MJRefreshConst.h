...
FOUNDATION_EXPORT NSString *const MJRefreshHeaderTimeKey;

FOUNDATION_EXPORT NSString *const MJRefreshContentOffset;
FOUNDATION_EXPORT NSString *const MJRefreshContentSize;