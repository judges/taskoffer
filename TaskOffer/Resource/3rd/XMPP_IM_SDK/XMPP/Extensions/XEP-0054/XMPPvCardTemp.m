...
#pragma mark ADR
- (NSArray *)addresses {
    DDXMLElement *email = [self elementForName:@"ADR"];
    NSArray *array = [email children];
    return array;
}
...
- (void)setAddresses:(NSArray *)adrs
{
    ...
    DDXMLElement *element = [DDXMLElement elementWithName:@"ADR"];
    
    for (NSString *string in adrs)
    {
        DDXMLElement *work = [DDXMLElement elementWithName:@"WORK"];
        DDXMLElement *tmp = [DDXMLElement elementWithName:@"POBOX" stringValue:string];
        [element addChild:work];
...
- (void)clearAddresses
{
    ...
    {
        if ([element.name isEqualToString:@"ADR"])
        {
...
{
    DDXMLElement *email = [self elementForName:@"TEL"];
    NSArray *array = [email children];
    return array;
}
...
- (void)setTelecomsAddresses:(NSArray *)tels
{
    ...
    DDXMLElement *element = [DDXMLElement elementWithName:@"TEL"];
    
    for (NSString *tel in tels)
    {
        DDXMLElement *work = [DDXMLElement elementWithName:@"WORK"];
        DDXMLElement *cell = [DDXMLElement elementWithName:@"CELL"];
        DDXMLElement *number = [DDXMLElement elementWithName:@"NUMBER" stringValue:tel];
        [element addChild:work];
        [element addChild:cell];
...
- (void)clearTelecomsAddresses
{
    ...
    for (NSXMLElement *element in array)
    {
        if ([element.name isEqualToString:@"TEL"])
        {
            [self removeChildAtIndex:[[self children] indexOfObject:element]];
        }
    }
...
{
    DDXMLElement *email = [self elementForName:@"EMAIL"];
    NSArray *array = [email children];
    return array;
}
...
- (void)setEmailAddresses:(NSArray *)emails
{
    ...
    DDXMLElement *element = [DDXMLElement elementWithName:@"EMAIL"];
    
    for (NSString *email in emails)
    {
        DDXMLElement *internet = [DDXMLElement elementWithName:@"INTERNET"];
        DDXMLElement *pref = [DDXMLElement elementWithName:@"PREF"];
        DDXMLElement *userid = [DDXMLElement elementWithName:@"USERID" stringValue:email];
        
        [element addChild:internet];
        [element addChild:pref];
...
- (void)clearEmailAddresses
{
    ...
    for (NSXMLElement *element in array)
    {
        if ([element.name isEqualToString:@"EMAIL"])
        {
            [self removeChildAtIndex:[[self children] indexOfObject:element]];
        }
    }
